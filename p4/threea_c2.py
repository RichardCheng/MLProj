...
s1 = subprocess.check_output('svm_learn.exe -c '+bestc+' "D:/Documents/Dropbox/MLProj/p4/arxiv/arxiv.train" "D:/Documents/Dropbox/MLProj/p4/arxiv/temp/nonnorm_train.model"')
