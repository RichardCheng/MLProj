...
s1 = subprocess.check_output('svm_learn.exe -c '+bestc+' -j 10 "D:/Documents/Dropbox/MLProj/p4/arxiv/arxiv.norm.train" "D:/Documents/Dropbox/MLProj/p4/arxiv/temp/norm_train.model"')
