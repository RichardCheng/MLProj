...
#read line
doc = []
for line in fileinput.input(['D:/Documents/Dropbox/MLProj/p4/arxiv/arxiv.train']):
    doc.append(line)
...
for i in range(0,4):
    ...
    for c in ('0.001', '0.01', '0.1', '1'):
        s1 = subprocess.check_output('svm_learn.exe -c ' +c+ ' "'+testfile+'" "D:/Documents/Dropbox/MLProj/p4/arxiv/temp/nonnorm_train_4fold.model"')
        s2 = subprocess.check_output('svm_classify.exe "'+validfile+'" "D:/Documents/Dropbox/MLProj/p4/arxiv/temp/nonnorm_train_4fold.model" "D:/Documents/Dropbox/MLProj/p4/arxiv/temp/nonnorm_train_4fold.result"')
